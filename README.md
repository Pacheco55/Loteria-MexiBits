...
- Usa Loteria MEXIBITS como un "ice breaker" en tus eventos. Es una actividad sencilla y divertida que une a las personas.
...
<!-- IMAGEN SUGERIDA: Aquí va una captura de la pantalla de inicio o menú principal, donde se puedan ver las opciones para elegir la baraja "Mexicana" o "Verde". -->
...
<!-- IMAGEN SUGERIDA: Una captura de la pantalla durante una partida. Debería mostrar la carta que acaba de ser "cantada" en grande y el contador de cartas. -->
...
<!-- IMAGEN SUGERIDA: Una captura mostrando la interfaz con la baraja "Verde" seleccionada, para resaltar la dualidad de la aplicación. -->
